...
This is Kells Kearney's ZenPack.community.mib_utils ZenPack, updated to work with Zenoss 3.2.x  It has been tested 
with Zenoss 3.2.1 and with Firefox 3.6.13 and 4.0b12.  No functional enhancements have been made and the testing 
emphasis has been on the MIB Browser functionality, rather than any other features.

This ZenPack does NOT work with Zenoss 3.1.x.
...
===========================
    ...
    * Zenoss Versions Supported: 3.2.x.  NOT 3.1.x
